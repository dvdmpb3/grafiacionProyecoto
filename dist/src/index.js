...
function pza1DerFunc() {
    var af = 10;
    Rota3D.initRotate(obj.w[300], obj.w[301], af * Math.PI / 180);
    for (var i = 1; i <= 24; i++) {
    ...
    cv.paint();
    var af1 = 10;
    Rota3D.initRotate(obj.w[300], obj.w[301], af1 * Math.PI / 180);
...
function pza1IzqFunc() {
    ...
    cv.paint();
    var af2 = -10;
    Rota3D.initRotate(obj.w[300], obj.w[301], af2 * Math.PI / 180);
    for (var i = 100; i <= 116; i++) {
        obj.w[i] = Rota3D.rotate(obj.w[i]);
    }
    cv.setObj(obj);
...
document.getElementById('pza12Mllave').addEventListener('click', pza12Moverllave, false);
document.getElementById('pza12Mllavec').addEventListener('click', pza12MoverllaveC, false);
var Pix, Piy;
var Pfx, Pfy;
